...
{ //Person Class
   ...
   private LinkedList donationList = new LinkedList(); 
   ...
   public LinkedList getDonationList(){return donationList;}
   public void setDonationList(LinkedList donationList){
...
/****************************************************************/      
   ...
   public String toSave(){
       String str = ID + "/" + lastName + "/" + firstName + "/" + bloodType;
       return str; 
   }
}//end Person class